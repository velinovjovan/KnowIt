function Box({ children, title, text }) {
  return (
    <div className="group relative max-w-[30rem] px-12 py-6 flex flex-col rounded-3xl hover:-translate-y-2 transition-all duration-500 bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-sm shadow-2xl border border-slate-700/50 hover:border-cyan-500/50 hover:shadow-cyan-500/20">
