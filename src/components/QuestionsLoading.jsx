function QuestionsLoading() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-6 py-20 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center bg-gradient-to-br from-slate-800/90 to-slate-900/90 border border-slate-700/50 backdrop-blur-sm rounded-3xl shadow-2xl p-12 hover:border-cyan-500/30 hover:shadow-cyan-500/10 transition-all duration-500">
        <div role="status" className="flex flex-col items-center">
          <svg
            aria-hidden="true"
            className="w-20 h-20 text-slate-700 animate-spin fill-cyan-500 drop-shadow-lg"
            viewBox="0 0 100 101"
            fill="none"
        ...
        <p className="mt-8 text-gray-200 text-xl md:text-2xl font-semibold">
          Loading Questions...
        </p>
      </div>
    </div>
